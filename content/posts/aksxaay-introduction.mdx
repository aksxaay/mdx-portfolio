...
It's crazy to think that I'll have a CS degree by the time anyone reads this. Currently, I'm enjoying working on <span style={{color: "violet"}}>**Web Development**</span> projects.
...
I very vividly remember one find day coming across a particular edit of a certain game, and it captivated me so much upto the point where I spent the next 2 years perfecting my craft on Digital Video Medium, Everything from Digital camera work, Time and Keyframe interpolation, Animations, Typography, 3D Modelling, Abstract Design etc. I still have my works from that era, feel free to check them out [@juanweeb](https://www.instagram.com/juanweeb/) on Instagram.
